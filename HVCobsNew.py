...
NBLOCKS = 100                    # blocks per capture (was undefined)
...
def capture_and_average(nobs, sdr, result_queue):
    ...
    for i in range(nobs):
        ...
        # x_complex has shape (NBLOCKS, NSAMPLES), window has shape (NSAMPLES)
        # Numpy broadcasting automatically applies the window to every block
